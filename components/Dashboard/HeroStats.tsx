...
export const HeroStats: React.FC<HeroStatsProps> = ({
  ...
  const strokeDashoffset = circumference - (goalsProgress / 100) * circumference;
  ...
  return (
    <View className="flex-row justify-between mb-6">
      ...
      >
        ...
        <View style={{ width: size, height: size, position: 'relative', justifyContent: 'center', alignItems: 'center' }}>
            ...
            <View className="absolute items-center justify-center">
                <Text className="text-lg font-bold" style={{ color: colors.textPrimary }}>{goalsProgress}%</Text>
            </View>
        </View>
      </View>
      ...
      >
        ...
        <View>
            <Text className="text-3xl font-bold" style={{ color: colors.textPrimary }}>{weeklyCompletionRate}%</Text>
